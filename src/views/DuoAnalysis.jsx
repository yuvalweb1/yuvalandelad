...
export default function DuoAnalysis({ t, onBack }) {
  return (
    <div className="no-sb" style={{
      height: '100%', overflowY: 'auto', background: '#FFF5E6',
      display: 'flex', flexDirection: 'column', padding: '24px 20px 28px',
    }}>
      <button onClick={onBack} className="press" style={{
        alignSelf: 'flex-start', background: '#fff', border: '2px solid rgba(255,184,0,0.35)',
        color: '#4A0E4E', padding: '8px 14px', borderRadius: 999, cursor: 'pointer',
        fontSize: 13, fontWeight: 700,
        boxShadow: '0 4px 0 rgba(255,184,0,0.22)',
      }}>
        {t.rm_back || '← Back'}
      </button>
