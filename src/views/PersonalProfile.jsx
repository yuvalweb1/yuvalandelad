...
export default function PersonalProfile({ t, onBack }) {
  return (
    <div className="no-sb" style={{
      height: '100%', overflowY: 'auto', background: '#EAF6FF',
      display: 'flex', flexDirection: 'column', padding: '24px 20px 28px',
    }}>
      <button onClick={onBack} className="press" style={{
        alignSelf: 'flex-start', background: '#fff', border: '2px solid rgba(0,191,255,0.35)',
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', gap: 14 }}>
        ...
        <div className="fs-display" style={{
          ...
          {t.tz_profile || 'Your personal profile'}
        </div>
        <div className="fs-mono" style={{
          fontSize: 13, color: 'rgba(74,14,78,0.55)', fontStyle: 'italic',
          maxWidth: 260,
        }}>
          {t.profile_coming_soon || 'Coming soon.'}
        </div>
      </div>
    </div>
  );
