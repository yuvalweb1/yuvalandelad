...
// driven by parseChat() from ./parser/client.js.
// ANALYTICS — extracted to ./lib/analytics (computeAll + helpers).
// SAMPLE DATA — extracted to ./lib/sample (generateSampleText).
// ============================================================
