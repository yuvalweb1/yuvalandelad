...
export const SEASON_SLIDES_BY_TYPE = {
  family: [
    ...
    'signature_words', 'photos', 'stickers', 'videos',
    'share',
  ],
  friends: [
    'ready', 's3_intro', 's3_trend',
  ...
  couple: [
    'ready', 's3_intro', 's3_trend',
    'messages_sent', 's3_ms_strongest', 's3_ms_quietest', 's3_mo_streak', 's3_ms_affectionate',
    's3_mo_biggest_convo', 'm4_lb_photographer', 's3_mo_longest_convo',
    's3_v_response', 's3_v_earlier_later', 'm4_vs_weekday_weekend',
    'love_you', 'signature_words', 'photos', 'stickers', 'videos',
    'share',
  ],
  other: [
    'ready', 's3_intro', 's3_trend',
