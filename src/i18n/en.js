export default {
  ...
  ruins_title_eyebrow: 'The Ruins of',
  ruins_title_meta: '{n} ruins lost to the dark',
  ...
  ruins_hud_heart: 'Heart',
  ruins_restored_count: '{sealed}/{total} restored',
  ruins_onboard_move: 'Drag to explore the dark',
  ruins_onboard_goal: 'Your lantern lights the ruins. Reach a glowing marker to investigate what happened there.',
  ...
  // Case scene chrome
  ruins_case_file: 'Case File',
  ruins_to_uncover: 'To uncover',
  ruins_begin: 'Begin investigation',
  ruins_continue: 'Continue',
  ruins_beat_excavate: 'Excavate',
  ruins_beat_interrogate: 'Interrogate',
  ruins_beat_reconstruct: 'Reconstruct',
  ruins_witness_tag: 'Witness',
  ruins_pair_pick_te: 'Pick a line of testimony',
  ruins_pair_pick_slot: 'tap the question it answers',
  ruins_recon_pick_msg: 'Tap an unsigned message',
  ruins_recon_pick_who: 'tap who you think said it',
  ruins_suspects: 'Suspects',
  ruins_verdict_eyebrow: 'The verdict board',
  ruins_verdict_title: 'Commit your findings',
  ruins_verdict_hint: 'Once stamped, the record is final.',
  ruins_stamp: 'Stamp the verdict',
  ruins_seal_label: 'Seal earned',
