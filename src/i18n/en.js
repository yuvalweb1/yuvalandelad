export default {
  ...
  pay_subtitle: 'Premium · {price}/month',
  pay_method_bit: 'Bit',
  ...
  settings_premium_subscribed: '₪15 / month · all video & banner ads removed',
  settings_premium_upsell_eyebrow: 'Remove ads',
  settings_premium_upsell_title: 'Skip every ad · ₪15/mo',
  ...
  promo_subtitle: 'Skip every single ad',
  promo_benefit_1: 'No video ads, ever',
  promo_benefit_2: 'No banner ads',
  promo_benefit_3: 'Support the dev',
  promo_cta: 'Upgrade · ₪15/mo',
