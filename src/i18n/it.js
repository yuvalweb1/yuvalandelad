export default {
  ...
  peak_3am: 'Tutto bene? Sul serio.',
  peak_morning: 'Persona del mattino. Bravo.',
  peak_midday: 'In orario di lavoro. Molto professionale.',
  peak_evening: 'Modalità relax. La rispettiamo.',
  peak_late: 'I pensieri colpiscono diverso a mezzanotte.',
  night_eyebrow: 'TRA MEZZANOTTE E LE 6',
  night_of_msgs: 'dei tuoi messaggi.',
  night_diag_strong: 'Il letto è LÌ.',
  night_diag_med: 'Ancora sveglio. Ancora a scrivere.',
  night_diag_low: 'Sonno più o meno normale. Bravo.',
  ...
  drama_replied_label: '% dei tuoi msgs ha avuto risposta',
  drama_replied_copy: 'La gente ti risponde davvero. È raro, eh.',
  ...
  drama_steady_label: 'giorni con l\'ultima parola',
  drama_steady_copy: 'Niente drama, niente caos. Affidabile, sempre lì.',
  roast_eyebrow_mild: '✦ NOTE GENTILI',
  roast_eyebrow_med: '✦ TI LEGGIAMO',
  roast_eyebrow_spicy: '🔥 SENZA PIETÀ',
  roast_heading_mild: 'Con affetto. Più o meno.',
  roast_heading_med: 'Ok. Dobbiamo parlare.',
  roast_heading_spicy: 'Senza pietà. Tieniti forte.',
