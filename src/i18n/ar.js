export default {
  ...
  peak_eyebrow: 'ساعتك',
  peak_3am: 'هل أنت بخير؟ بجد.',
  peak_morning: 'شخص صباحي. احترام.',
  peak_midday: 'في ساعات العمل. احترافي جداً.',
  peak_evening: 'وضع الاسترخاء. نحترم ذلك.',
  peak_late: 'الأفكار تختلف بعد منتصف الليل.',
  night_eyebrow: 'بين منتصف الليل و6 صباحاً',
  night_of_msgs: 'من رسائلك.',
  night_diag_strong: 'السرير هناك تماماً.',
  night_diag_med: 'ما زلت مستيقظاً. ما زلت تكتب.',
  night_diag_low: 'نوم شبه طبيعي. أحسنت.',
  night_diag_none: 'تنام فعلاً. احترام.',
  ...
  drama_killer_copy: 'تكتب. الجميع يصمت. لا نقول شيئاً، لكن…',
  drama_replied: 'الجميع يردون عليك',
  drama_replied_label: '% من رسائلك تلقت رد',
  drama_replied_copy: 'الناس يردون عليك فعلاً. هذا نادر.',
  drama_ignored: 'متصل لكن متجاهل',
  drama_ignored_label: '% من رسائلك بدون رد',
  drama_ignored_copy: 'ليس أنت. بل هم. على الأرجح.',
  drama_steady: 'الثابت',
  drama_steady_label: 'أيام بالكلمة الأخيرة',
  drama_steady_copy: 'لا دراما، لا فوضى. مجرد حضور دائم.',
  roast_eyebrow_mild: '✦ ملاحظات لطيفة',
  roast_eyebrow_med: '✦ نكشفك بالكامل',
  roast_eyebrow_spicy: '🔥 بلا رحمة',
  roast_heading_mild: 'بمحبة. في الغالب.',
  roast_heading_med: 'حسناً. علينا أن نتحدث.',
  roast_heading_spicy: 'بلا رحمة. استعد جيداً.',
