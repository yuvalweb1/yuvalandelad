export default {
  ...
  // ── החורבות של [שם הקבוצה] (משחק מצב חורבות) ─────────────
  ruins_title: 'החורבות של {group}',
  ruins_title_eyebrow: 'החורבות של',
  ruins_title_meta: '{n} חורבות אבדו באפלה',
  ruins_start: 'היכנסו',
  ruins_opening_lead: 'הרשומות חתומות. הסיעות משקרות. אתם חדשים — אף אחד לא יחשוד שיש לכם צד.',
  ruins_empty_title: 'החורבות שקטות',
  ruins_empty_body: 'אין כאן עדיין מספיק כאוס כדי לבנות ממלכה. נסו צ\'אט תוסס יותר.',
  // העולם
  ruins_district_gates: 'השער והפרברים',
  ruins_district_era: 'רובע {name}',
  ruins_district_era_fallback: 'הרובע הישן',
  ruins_heart_label: 'הלב {pct}%',
  ruins_hud_heart: 'הלב',
  ruins_restored_count: '{sealed}/{total} שוקמו',
  ruins_onboard_move: 'גררו כדי לחקור את האפלה',
  ruins_onboard_goal: 'הפנס שלכם מאיר את החורבות. הגיעו לסמן זוהר כדי לחקור מה קרה שם.',
  ruins_investigate: 'חקרו',
  ruins_revisit: 'חזרו לתיק',
  ruins_hook_more: 'שאר הממלכה מחכה בערפל — עוד חורבות בדרך.',
  ruins_lead_elsewhere: 'עדים מספרים על משהו שמתעורר ב{district}.',
  // משבצות פסק הדין (משותפות לכל התיקים)
  ruins_slot_when: 'מתי זה קרה?',
  ruins_slot_who: 'מי התחיל את זה?',
  ruins_slot_who_ignite: 'מי הצית את הפתיל?',
  ruins_slot_last: 'למי הייתה המילה האחרונה?',
  ruins_slot_author: 'מי אמר את זה?',
  // תיק א׳ — הניצוץ הראשון (הדרכה: חפירה + שחזור)
  ruins_case_a_title: 'הניצוץ הראשון',
  ruins_case_a_lead: 'כתם חרוך זוהר מעבר לשער. משהו קרה כאן.',
  ruins_excavate_hint: 'גררו על פני ההריסות כדי לחפור.',
  ruins_excavate_reveal_when: 'שבר, חצי שרוף: זה קרה ב{bucket}.',
  // תיק ב׳ — האולם המרעיש (תחקור)
  ruins_case_b_title: 'האולם המרעיש',
  ruins_case_b_lead: 'הד נותר כאן, להוט לדבר — אם תשאלו את השאלות הנכונות.',
  ruins_testimony_who: '{name} לא הפסיק/ה להגיד "{word}" — זה האשם שלכם.',
  ruins_testimony_when: 'זה היה עמוק ב{bucket}. אני זוכר/ת בדיוק.',
  ruins_testimony_last: '{name} קיבל/ה את המילה האחרונה. כמו תמיד.',
  ruins_pair_hint: 'הקישו על עדות, ואז על השאלה שהיא עונה עליה.',
  ruins_slot_empty: '— הניחו ראיה כאן —',
  // תיק ג׳ — הכיכר השבורה (שחזור)
  ruins_case_c_title: 'הכיכר השבורה',
  ruins_case_c_lead: 'קולות, קפואים באמצע משפט. של מי המילים האלה?',
  ruins_pair_hint_recon: 'הקישו על הודעה, ואז על מי שלדעתכם אמר אותה.',
  // וריאציות תבנית — חזרות עם עיטור אחר (שלב 2)
  ruins_t0_v1_title: 'השעה הטמונה',
  ruins_t0_v1_lead: 'משהו טמון כאן למחצה — רגע, קפוא באמצע משפט.',
  ruins_t0_v2_title: 'הספסל הנשכח',
  ruins_t0_v2_lead: 'פינה שקטה מחזיקה שבר שאף אחד לא חשב לשמור.',
  ruins_t1_v1_title: 'גלריית הלחישות',
  ruins_t1_v1_lead: 'קולות מצטלבים בחדר הזה — הפרידו עובדה מהד.',
  ruins_t1_v2_title: 'חצר ההדים',
  ruins_t1_v2_lead: 'עד ישן מחכה, מוכן להעיד — במחיר של תשומת לב.',
  ruins_t2_v1_title: 'רצפת הפסיפס',
  ruins_t2_v1_lead: 'אריחים, כל אחד חרוט בקול אחר — הרכיבו אותם בחזרה.',
  ruins_t2_v2_title: 'המזרקה הסדוקה',
  ruins_t2_v2_lead: 'מילים מתאדות על פני המים, בלי חתימה. למי הן שייכות?',
  // דמויות אגדיות — פסלים ושברי הד לכל חבר/ה
  ruins_slot_figure_who: 'של מי ההד הזה?',
  ruins_figure_unit_count: '{n}×',
  ruins_figure_unit_pct: '{pct}%',
  ruins_figure_lightbringer_title: 'כן הלהבה הנצחית',
  ruins_figure_lightbringer_lead: 'פסל מחזיק לפיד שלא נכבה. את מי הוא מנציח?',
  ruins_figure_lightbringer_tell1: 'התחלתי את הצ\'אט מחדש {n} פעמים. מישהו צריך.',
  ruins_figure_lightbringer_tell2: 'כרגיל עם \'{word}\'. זה עובד.',
  ruins_figure_closer_title: 'הקבר ללא שם',
  ruins_figure_closer_lead: 'מצבה בלי שם — רק שקט עוקב אחרי מי שחרט אותה.',
  ruins_figure_closer_tell1: '{n} שיחות נגמרו ממש אחרי שדיברתי. צירוף מקרים? אולי.',
  ruins_figure_closer_tell2: 'המילה האחרונה שלי היא כרגיל \'{word}\'. ואז... שקט.',
  ruins_figure_sentinel_title: 'משמר הלילה',
  ruins_figure_sentinel_lead: 'פסל עומד על המשמר בקצה רובע הלילה, עיניים פקוחות.',
  ruins_figure_sentinel_tell1: '{pct}% מההודעות שלי נשלחו אחרי חצות.',
  ruins_figure_sentinel_tell2: 'רובע הלילה לא נרדם. גם אני לא.',
  ruins_figure_herald_title: 'השופר שעדיין חם',
  ruins_figure_herald_lead: 'שופר מונח על כן, עדיין חם. של מי הייתה הנשיפה האחרונה שמילאה אותו?',
  ruins_figure_herald_tell1: '{n} הודעות קוליות. יש דברים שאי אפשר להקליד.',
  ruins_figure_herald_tell2: '{pct}% מהדברים שלי, הייתם צריכים להקשיב להם.',
  ruins_figure_illuminator_title: 'הפנס המאיר',
  ruins_figure_illuminator_lead: 'פנס בוער באור שאי אפשר לבלבל עם שום דבר אחר. כולם מכירים אותו — אבל של מי הוא?',
  ruins_figure_illuminator_tell1: '{emoji} — השתמשתי בו {n} פעמים. זו בעצם החתימה שלי.',
  ruins_figure_illuminator_tell2: 'תכירו את ההודעות שלי לפי ה{emoji}.',
  ruins_figure_vanished_title: 'הכן הריק',
  ruins_figure_vanished_lead: 'כן ריק. משהו — מישהו — עמד כאן פעם.',
  ruins_figure_vanished_tell1: 'נעלמתי ל-{n} ימים פעם אחת. אף אחד לא שם לב עד שחזרתי.',
  ruins_figure_vanished_tell2: 'הכן היה ריק כל הזמן.',
  ruins_figure_stormcaller_title: 'צריח הסופה',
  ruins_figure_stormcaller_lead: 'צלקות ברק קורנות מהצריח הזה בפרצים מהירים וחופפים.',
  ruins_figure_stormcaller_tell1: '{n} הודעות ברצף. היה לי הרבה מה להגיד.',
  ruins_figure_stormcaller_tell2: 'אף אחד לא הצליח להכניס מילה עד שסיימתי.',
  // מקדש הבדיחה — תיקי-מיני של ביטויים חוזרים
  ruins_slot_joke_phrase: 'מה הייתה הבדיחה החוזרת?',
  ruins_joke_title: 'הביטוי הקדוש',
  ruins_joke_lead: 'חריצים שחוקים מאייתים מילים שחזרו על עצמן עד שהפכו למנהג.',
  ruins_joke_excavate_fragment: 'משהו חרוט כאן, שוב ושוב, מלוטש מחזרה אינסופית.',
  ruins_joke_excavate_reveal: 'הם אמרו את זה {count} פעמים, במהלך {weeks} שבועות: "{phrase}"',
  ruins_joke_meta_count: '{count}× חזרות',
  ruins_joke_meta_weeks: 'במהלך {weeks} שבועות',
  // מסגרת מסך התיק
  ruins_case_file: 'תיק חקירה',
  ruins_to_uncover: 'מה לחשוף',
  ruins_begin: 'התחילו בחקירה',
  ruins_continue: 'המשיכו',
  ruins_beat_excavate: 'חפירה',
  ruins_beat_interrogate: 'תחקור',
  ruins_beat_reconstruct: 'שחזור',
  ruins_witness_tag: 'עד/ה',
  ruins_pair_pick_te: 'בחרו שורת עדות',
  ruins_pair_pick_slot: 'הקישו על השאלה שהיא עונה עליה',
  ruins_recon_pick_msg: 'הקישו על הודעה ללא חתימה',
  ruins_recon_pick_who: 'הקישו על מי שלדעתכם אמר אותה',
  ruins_suspects: 'חשודים',
  ruins_verdict_eyebrow: 'לוח פסק הדין',
  ruins_verdict_title: 'נעלו את הממצאים',
  ruins_verdict_hint: 'לאחר החתימה, הרשומה סופית.',
  ruins_stamp: 'חתמו על פסק הדין',
  ruins_seal_label: 'חותם הושג',
  ruins_grade_gold: 'זהב',
  ruins_grade_silver: 'כסף',
  ruins_grade_bronze: 'ארד',
  ruins_truth_was: 'האמת:',
  ruins_what_happened: 'מה שקרה באמת',
  ruins_new_leads: 'רמזים חדשים',
  ruins_return_kingdom: 'חזרו לממלכה',
  // אריח בתפריט אחרי הסיכום
  menu_ruins_eyebrow: 'מצב חורבות',
  menu_ruins_title: 'החורבות',
};
