export default {
  ...
  vote_pass_body: 'כולם האחרים — הסתכלו לכיוון אחר, ההצבעה שלכם סודית.',
  vote_pass_cta: 'אני {name} — בואו נתחיל',
  ...
  gc_setup_title: 'השבעת חבר המושבעים',
  gc_setup_body: 'הוסיפו את כל המשתתפים. כל מושבע מצביע בסוד — העבירו את הטלפון כשמגיע תורו.',
  gc_setup_cta: 'השבעת חבר המושבעים',
  gc_case_of: 'תיק {n} מתוך {total}',
  gc_case_file: 'תיק החקירה',
  gc_tap_reveal: 'הקישו לחיסיון',
  gc_cast_vote: 'הצבעה',
  ...
  ht_setup_body: 'הוסיפו את כל המשתתפים. כל שחקן מצביע בסוד — העבירו את הטלפון כשמגיע תורו.',
  ...
  ht_s_would_die: 'הקבוצה הזו הייתה גוועת בלי אדם אחד.',
  ...
  // שורות ראיה (evidenceVars: n, name)
  ht_ev_most_important: '{name} שולח/ת {n}% מכל ההודעות — ומחזיר/ה את הצ\'אט לחיים הכי הרבה.',
  ht_ev_most_important_misleading: '{name} שולח/ת {n}% מכל ההודעות — אבל לא מי שמחזיר/ה את הצ\'אט לחיים.',
  ht_ev_would_die: 'אדם אחד החזיר את הצ\'אט לחיים {n} פעמים — כל השאר, הרבה פחות.',
