export default {
  ...
  drama_killer_copy: 'Você digita. Todo mundo cala. A gente não fala nada, mas…',
  drama_replied: 'Todo Mundo Te Responde',
  drama_replied_label: '% das suas msgs receberam resposta',
  drama_replied_copy: 'As pessoas respondem mesmo. Isso é raro.',
  ...
  drama_steady_label: 'dias com a última palavra',
  drama_steady_copy: 'Sem drama, sem caos. Confiável, sempre presente.',
  ...
  roast_heading_med: 'Olha. Precisamos conversar.',
  roast_heading_spicy: 'Sem piedade. Se segura.',
